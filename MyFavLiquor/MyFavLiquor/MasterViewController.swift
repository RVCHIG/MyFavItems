...
//        navigationItem.rightBarButtonItem = addButton
        listArray = ["Yamazaki 12", "Deep Eddy Lemon", "El Mayor Reposado", "Four Roses Yellow Label", "Gekkeikan Plum", "Kung Fu Girl Riesling", "Stolichnaya Vodka", "Zaya Dark Rum"]
        title = "My Favorite Liquors"
